  ...
  return (
    <>
      <div
        ...
        >
        <div
          className='flex flex-col w-3/4 justify-center items-center m-auto text-gray-800 font-bold text-justify'
        >
          <p className='mt-10 text-2xl'>Acerca de OnFocus</p>
          <p className='mt-10 text-sm md:text-base font-black indent-14'>
